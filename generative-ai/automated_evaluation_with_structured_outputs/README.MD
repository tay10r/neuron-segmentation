...
After deploying the model, open Swagger clicking the URL of the local deployment.
...
After deploying the model, click the link at the top of the swagger API page to access HTML UI.
